...
const Home = () => {
  return (
    <div id='home' name='home' className='bg-[#1e2528] w-full h-screen'>    
      
    <div id='container' className='max-sm:ml-5 max-w-[1000px] mx-auto flex flex-col justify-center h-full'>
      <p className='text-8xl max-sm:text-5xl text-[#c0f4e8]'>Hello, 
      {/* <span class="">
      <Typed
        strings={["Hello","Konichiwa","Vadakkam",]}
        typeSpeed={100}
        backSpeed={100}
        loop
        />
      ...
      <div className='max-sm:text-3xl pt-7 text-5xl text-[#0EF6BE]'>
        <button className='border-2 max-sm:px-3 px-6 py-3 my-2 flex items-center border-white bg-[black] shadow-xl shadow-black hover:bg-[#3A504B] hover:border-[#0EF6BE]'> <a href="#contact">Get in touch</a><HiArrowNarrowRight className='ml-3'/> </button> 
      </div>
